...
const F101Segment = () => (
  <div>
    <br />
    <b>
      We know entering college can be a both exciting and overwhelming
      experience, so we got you covered! SHPE UF has put together this Freshman
      101 Document Series with everything you should know as an incoming Gator.
      Learn from our members advice and what they wish they knew as first years!
    </b>
    <Grid divided centered>
      <Grid.Column width={5}>
  ...
  <div>
    ...
    <Grid divided centered>
      <Grid.Column width={5}>
        ...
        <Image
          src={GradSHPEresearch}
          as="a"
          size="medium"
          href="https://drive.google.com/file/d/19sO_QNUR64oGxbp3293Dy2ltChsAAUW-/view"
          target="_blank"
        />
        <Divider />
        <Button
      ...
      <Grid.Column width={5}>
        ...
        <Image
          src={GradSHPEschool}
          as="a"
          href="https://drive.google.com/file/d/1iytv-CCITpX3xkSKI6kfkI1P09mbpxKc/view?usp=sharing"
          target="_blank"
          size="medium"
        />
        <Divider />
