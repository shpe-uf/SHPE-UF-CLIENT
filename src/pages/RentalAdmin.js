      ...
      <Container className="body">
        {receipts ?
          <Tab panes={[
            ...
            {menuItem: 'Returned', render: () => <Tab.Pane><ReceiptTable receipts={receipts.filter(e => e.dateClosed && !e.deleted)} type='returned'/></Tab.Pane>},
            {menuItem: 'Deleted', render: () => <Tab.Pane><ReceiptTable receipts={receipts.filter(e => e.deleted)}  type='deleted'/></Tab.Pane>},
          ]}/>
          :
          <Loader active />
        }
